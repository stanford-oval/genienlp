...
lang2country = {'sa': 'saudi-arabia', 'de': 'germany', 'es': 'spain', 'ir': 'iran', 'fi': 'finland', 'it': 'italy', 'jp': 'japan', 'pl': 'poland', 'tr': 'turkey', 'cn': 'china' }
...
def offset_image(coord, name, ax):
    ...
    im.image.axes = ax
    ab = AnnotationBbox(im, (coord, 0),  xybox=(27, -40), frameon=False,
