...
def compute_metrics(
    ...
    return {'bleu': total_bleu / len(all_bleu), 'em': 100.0 * total_exact_match / len(all_exact_matches), 'ece': ece, 'ada_ece': ada_ece, 'prediction_acc': 100.0 * correct_predictions / len(all_exact_matches)}
